...
export function PresalesWorkspace({ token, contextKey, storageKey, openDocuments, readOnly = false, initialVersionId, onInitialVersionConsumed }: { token: ApiCredential | null; contextKey: string; storageKey: string; openDocuments: () => void; readOnly?: boolean; initialVersionId?: string; onInitialVersionConsumed?: () => void }) {
