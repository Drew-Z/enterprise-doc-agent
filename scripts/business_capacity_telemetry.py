...
def parse_metrics(text: str) -> dict[str, Any]:
    ...
    for family in families:
        for sample in family.samples:
            ...
            if sample.name not in GAUGES and (
    ...
    return {"gauges": gauges, "dependencies": dependencies, "nonfinite": sorted(set(nonfinite))}
    ...
    *,
    ...
    for sample in samples:
        ...
        for scrape in sample["scrapes"]:
            ...
            elif any(value is None for value in metrics["gauges"].values()):
    ...
    return {
        ...
        "limitations": [
            ...
            "Queue and Redis gauges lack a verified producer freshness contract; "
            "zeros are not idle proof.",
